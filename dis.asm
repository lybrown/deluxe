...
LADD9       lda L00AD              ; A5 AD
            ...
            sta L00A5,X            ; 95 A5
            jmp LAE54              ; 4C 54 AE
LADF7       lda ICBLLZ,Y           ; B9 28 00
LADFA       sta L00A7,X            ; 95 A7
            sta HPOSP1,X           ; 9D 01 D0
            lda L009E              ; A5 9E
            sec                    ; 38
            sbc STATUS,Y           ; F9 30 00
            tay                    ; A8
            dey                    ; 88
            dey                    ; 88
            lda LBB1A,Y            ; B9 1A BB
